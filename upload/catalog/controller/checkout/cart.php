...
class ControllerCheckoutCart extends Controller {
    ...
    /**
     * RIP modifications: This is RIP modified add function to help out the javascript function cart.add
     * this add function would ignore all the attributes of product (default of the opencart software)
     */
    public function ripAdd() {
        $this->load->language('checkout/cart');
        ...
        $json = array();
        $total = 0;
        //The info array from  the interface contains the id and the description of the product
        ...
        //Prepare the result that need to be sent back
        ...
        if ($this->customer->isLogged() || !$this->config->get('config_customer_price')) {
            ...
            foreach ($this->cart->getProducts() as $product_total) {
                $total += $product_total['total'];
            }
        }
        ...
        // $json['redirect'] = str_replace('&amp;', '&', $this->url->link('product/product', 'product_id=' . $this->request->post['product_info']));
    }

    //END of RIP mofifications
