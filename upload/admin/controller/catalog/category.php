...
class ControllerCatalogCategory extends Controller {
    ...
    public function add() {
        ...
        //If all our variables are set then we can start getting them ready for database
        $dbData = array();
        if (isset($this->request->get['descriptions']) && isset($this->request->get['package_name']) && isset($this->request->get['price'])) {
            $this->session->data['success'] = $this->language->get('text_success');
            $url = '';
            $dbData['package_name'] = $this->request->get['package_name'];
            foreach ($this->model_catalog_category->getPackages() as $package) {
                if ($package['package_name'] == $dbData['package_name']) {
                    $dbData['package_name'] = null;
                    $url = '&check=~!';
                    break;
                }
            }

            // If package_name is not null then we can enter it to db
            if ($dbData['package_name'] != null) {

                $dbData['price'] = $this->request->get['price'];
                $dbData['descriptions'] = $this->request->get['descriptions'];
                $this->model_catalog_category->addPackage($dbData);
            }
    ...
    public function edit() {
        ...
        $this->load->model('catalog/category');
$dbData = array();
        if (isset($this->request->get['editing'])) {
            $dbData['package_name'] = $this->request->get['package_name'];
             $dbData['editing'] = $this->request->get['editing'];
            ...
            $this->model_catalog_category->updatePackage($dbData);
    ...
    public function delete() {
        ...
        if (isset($this->request->get['package_name'])) {
            $dbData['package_name'] = $this->request->get['package_name'];
            $dbData['delete'] = $this->request->get['delete'];
            $this->model_catalog_category->updatePackage($dbData);
            $this->response->redirect($this->url->link('catalog/category', 'token=' . $this->session->data['token'], 'SSL'));
        }
...
//RIP modification: End.
    ...
    protected function getList() {
        ...
        $data['packages'] = $this->model_catalog_category->getPackages();
