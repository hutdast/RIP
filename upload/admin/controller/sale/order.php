...
class ControllerSaleOrder extends Controller {
    ...
    public function edit() {
        ...
        $this->load->model('sale/order');
        $param = [];
        if (isset($this->request->get['id']) && isset($this->request->get['status'])) {
            $param = array('id' => $this->request->get['id'],
                'status' => $this->request->get['status']);
        }
        $this->model_sale_order->updateRutikOrder($param);
    ...
    public function delete() {
        ...
        if (isset($this->request->get['id'])) {
            $this->model_sale_order->deleteRutikOrder($this->request->get['id']);
        }
    ...
    protected function getList() {
        $data['rust_order'] = $this->model_sale_order->rutikOrder();
